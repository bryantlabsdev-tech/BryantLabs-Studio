/**
 * Canonical redaction for provider API keys, Bearer tokens, and key headers.
 * Never log the input or output of this function from callers that still hold secrets.
 */
