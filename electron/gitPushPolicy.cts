/**
 * Electron copy of src/core/git/gitPushPolicy.ts.
 * electron/tsconfig rootDir is electron/, so main cannot import src/.
 * Shared vectors in src/core/git/gitPushPolicy.vectors.json prove identical behavior.
 */
