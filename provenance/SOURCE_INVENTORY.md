...
Not part of `bf3396e`. Added later in `04a13e`.
...
exclusions:
missing_evidence: Designer, assignment, and pre-commit creation date of the source PNG are unknown. generate-branding.mjs defaults to a Desktop PNG that is not in Git. Trademark clearance is unknown.
```
